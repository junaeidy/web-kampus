...
export default function EditNews() {
    ...
    const handleSubmit = (e) => {
        ...
        post(route("admin.news.update", news.id), {
            forceFormData: true,
            onSuccess: () => toast.success("Berita berhasil diperbarui 🎉"),
            onError: () =>
                toast.error("Gagal memperbarui berita. Silakan cek kembali."),
        });
    };
    ...
    const [thumbnailPreview, setThumbnailPreview] = useState(
        news.thumbnail_path ? `/storage/${news.thumbnail_path}` : null
    );
