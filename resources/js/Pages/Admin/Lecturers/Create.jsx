...
export default function CreateLecturer({ faculties }) {
    ...
    const handleSubmit = (e) => {
        ...
        post(route("admin.lecturers.store"), {
            ...
            onError: () =>
                toast.error("Gagal menambahkan dosen. Periksa kembali isian Anda."),
        });
    };
    ...
    return (
        <AuthenticatedLayout header="Tambah Dosen">
            <Head title="Tambah Dosen" />

            <div className="bg-white shadow rounded-lg p-6 max-w-4xl mx-auto space-y-6">
                <h2 className="text-lg font-semibold text-gray-800">Form Tambah Dosen</h2>
