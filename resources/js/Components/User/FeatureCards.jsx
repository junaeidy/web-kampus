    ...
    const features = [
        {
            ...
            description: 'Sistem Informasi Akademik yang terintegrasi untuk mahasiswa, dosen, dan administrasi kampus.',
            buttonText: 'Jelajahi',
            link: '',
        },
        {
            ...
            title: 'Jurnal',
            icon: Book,
            description: 'Akses ke publikasi ilmiah, jurnal penelitian, dan karya tulis dosen serta mahasiswa.',
            buttonText: 'Telusuri',
        ...
        },
        {
            ...
            title: 'PMB',
            icon: UserPlus,
            description: 'Informasi lengkap dan pendaftaran Penerimaan Mahasiswa Baru tahun ajaran ini.',
                            ...
                            <div className="relative z-10">
                                ...
                                >
                                    ...
                                    <span className="relative z-10 flex items-center">
                                        <span className="mr-2 group-hover/button:text-white transition-colors duration-300">{feature.buttonText}</span>
                                        <svg className="w-4 h-4 group-hover/button:text-white transition-transform duration-300 transform group-hover/button:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
