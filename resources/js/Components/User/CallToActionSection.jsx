        ...
        <section className="bg-custom-green py-20 px-4 text-white text-center flex items-center justify-center">
            <div className="container mx-auto max-w-4xl">
                ...
                <p className="text-lg md:text-xl leading-relaxed mb-10 opacity-90">
                    Bergabunglah dengan ribuan mahasiswa lainnya dan kembangkan
                    potensi terbaik Anda bersama kami. Kami berkomitmen untuk
                    menyediakan pendidikan berkualitas dan lingkungan belajar
                    yang inspiratif.
                </p>
                <a
                    target="_blank"
